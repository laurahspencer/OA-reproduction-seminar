...
## Phylum specific figures 

### Cnidaria 

```{r}
model.cnidaria <- glmmTMB(ave_fert_proport ~ p_h_experimental + (1|study), data=subset(data.fert, phylum=="Cnidaria"), binomial(link = "logit"), na.action=na.exclude)
...
ggplot() + 
  geom_jitter(data=subset(data.fert, phylum=="Cnidaria"), aes(x=p_h_experimental, y=ave_fert_proport), size=1.2, width=0.03, color="#e41a1c") +
  ggtitle("Cnidaria") + 
  xlab("Experimental pH") + ylab("Fertilization %") +
  theme_minimal() + 
  coord_cartesian(ylim = c(0, 1), xlim =c(6,8.5)) +
...
```{r}
model.crustacea <- glmmTMB(ave_fert_proport ~ p_h_experimental + (1|study), data=subset(data.fert, phylum=="Crustacea"), binomial(link = "logit"), na.action=na.exclude)
...
ggplot() + 
  geom_jitter(data=subset(data.fert, phylum=="Crustacea"), aes(x=p_h_experimental, y=ave_fert_proport), size=1.2, width=0.03, col="#ff7f00") +
  ggtitle("Crustacea") + 
  xlab("Experimental pH") + ylab("Fertilization %") +
  theme_minimal() + 
  coord_cartesian(ylim = c(0, 1), xlim =c(6,8.5)) +
...
```{r}
model.echinodermata <- glmmTMB(ave_fert_proport ~ p_h_experimental + (1|study), data=subset(data.fert, phylum=="Echinodermata"), binomial(link = "logit"), na.action=na.exclude)
...
ggplot() + 
  geom_jitter(data=subset(data.fert, phylum=="Echinodermata"), aes(x=p_h_experimental, y=ave_fert_proport), size=1.2, width=0.03, col="#4daf4a") +
...
```{r}
model.mollusca <- glmmTMB(ave_fert_proport ~ p_h_experimental + (1|study), data=subset(data.fert, phylum=="Mollusca"), binomial(link = "logit"), na.action=na.exclude)
...
ggplot() + 
  geom_jitter(data=subset(data.fert, phylum=="Mollusca"), aes(x=p_h_experimental, y=ave_fert_proport), size=1.2, width=0.03, col="#377eb8") +
  ggtitle("Mollusca") + 
  xlab("Experimental pH") + ylab("Fertilization %") +
  theme_minimal() + 
  coord_cartesian(ylim = c(0, 1), xlim =c(6,8.5)) +
